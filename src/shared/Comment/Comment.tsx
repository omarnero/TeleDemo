		...
		<div className="nc-CommentCard flex ">
			...
			<div className="ml-2 flex flex-grow flex-col rounded-xl border border-neutral-200 p-4 text-sm dark:border-neutral-700 sm:ml-3 sm:text-base">
				<div className="relative flex items-center pr-6">
					...
					<span className="text-xs text-neutral-500 line-clamp-1 dark:text-neutral-400 sm:text-sm">
						May 20, 2021
					</span>
				</div>
				<span className="mt-2 mb-3 block text-neutral-700 dark:text-neutral-300 sm:mt-3 sm:mb-4">
