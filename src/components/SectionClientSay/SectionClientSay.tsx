...
const DEMO_DATA = [
	{
		...
		content:
			"This place is exactly like the picture posted on Telefreik . Great service, we had a great stay!",
	},
	{
		id: 2,
	...
	const renderBg = () => {
		return (
			<div className="hidden md:block">
				...
				/>
				<img
					className="absolute left-full bottom-[80px] ml-32"
					src={clientSay5}
					alt=""
				/>
	...
	return (
		...
		>
			...
			<div className="relative mx-auto max-w-2xl md:mb-16">
				...
				<div className={`relative mt-12 lg:mt-16 ${UNIQUE_CLASS}`}>
					<img
					...
					<div
						className="glide__bullets mt-10 flex items-center justify-center"
						data-glide-el="controls[nav]"
					>
						{DEMO_DATA.map((item, index) => (
							<button
								key={item.id}
								className="glide__bullet mx-1 h-2 w-2 rounded-full bg-neutral-300 focus:outline-none"
