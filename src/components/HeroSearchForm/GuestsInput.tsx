		...
		<Popover className={`relative flex ${className}`}>
			{({ open }) => (
				<>
					...
					>
						<Popover.Button
							className={`flex flex-1 items-center text-left ${fieldClassName} space-x-3 `}
					...
					>
						<Popover.Panel className="absolute right-0 top-full z-10 mt-3 w-full max-w-sm rounded-3xl bg-white py-5 px-4 shadow-xl dark:bg-neutral-800 sm:min-w-[340px] sm:py-6 sm:px-8">
							<NcInputNumber
								className="w-full"
