	...
	return (
		<Popover className="relative flex flex-[1.3]">
			{({ open, close }) => (
				<>
					<div
						className={`flex flex-1 cursor-pointer items-center focus:outline-none ${
					...
					>
						<Popover.Panel className="absolute left-0 top-full z-10 mt-3 w-full max-w-sm rounded-3xl bg-white py-5 px-4 shadow-xl dark:bg-neutral-800 sm:min-w-[340px] sm:py-6 sm:px-8 lg:right-0">
									...
									<div>
										...
										<div className="relative mt-1 rounded-md">
											...
											<input
												...
												name="minPrice"
												id="minPrice"
												className="block w-full rounded-full border-neutral-200 pl-7 pr-3 text-neutral-900 focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
									...
									<div>
										...
										<div className="relative mt-1 rounded-md">
											...
											<input
												...
												name="maxPrice"
												id="maxPrice"
												className="focus:border-priring-primary-500 block w-full rounded-full border-neutral-200 pl-7 pr-3 text-neutral-900 focus:ring-primary-500 sm:text-sm"
