...
const StayCardH: FC<StayCardHProps> = ({
	...
	return (
		<div
			className={`nc-StayCardH group relative overflow-hidden rounded-2xl border border-neutral-100 bg-white transition-shadow will-change-transform hover:shadow-xl dark:border-neutral-800 dark:bg-neutral-900 ${className}`}
