		...
		<Popover className="[ nc-flex-1 ] relative flex">
			{({ open, close }) => (
				<>
					...
					>
						<Popover.Panel className="absolute left-0 top-full z-30 mt-3 w-full max-w-sm rounded-3xl bg-white py-5 px-4 shadow-xl dark:bg-neutral-800 sm:min-w-[340px] sm:py-6 sm:px-8 lg:right-0">
