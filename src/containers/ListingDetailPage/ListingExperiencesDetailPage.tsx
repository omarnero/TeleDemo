...
const ListingExperiencesDetailPage: FC<ListingExperiencesDetailPageProps> = ({
		...
		return (
			<div className="listingSection__wrap !space-y-6">
				...
				<div className="flex items-center justify-between space-x-8 text-sm text-neutral-700 dark:text-neutral-300 xl:justify-start xl:space-x-12">
					<div className="flex flex-col items-center space-y-3 text-center sm:flex-row sm:space-y-0 sm:space-x-3 sm:text-left ">
	...
	const renderSidebar = () => {
		return (
			<div className="listingSectionSidebar__wrap shadow-xl">
				...
				{/* FORM */}
				<form className="flex flex-col divide-y divide-neutral-200 rounded-3xl border border-neutral-200 dark:divide-neutral-700 dark:border-neutral-700 sm:flex-row sm:divide-y-0 sm:divide-x ">
					...
					<div className="listingExperiencesDetailPage__GuestsInput flex-1">
						<GuestsInput
							fieldClassName="p-4"
							defaultValue={{
								guestAdults: 1,
	...
	return (
		...
		>
			{/* SINGLE HEADER */}
			<>
				<header className="container rounded-md sm:rounded-xl 2xl:px-14">
					<div className="relative grid grid-cols-4 gap-1 sm:gap-2">
						...
						<div
							className="absolute left-3 bottom-3 z-10 hidden cursor-pointer rounded-xl bg-neutral-100 px-4 py-2 text-neutral-500 hover:bg-neutral-200 md:flex md:items-center md:justify-center"
							onClick={() => handleOpenModal(0)}
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
